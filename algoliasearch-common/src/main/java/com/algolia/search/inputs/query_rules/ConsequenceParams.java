...
public class ConsequenceParams extends Query {
  ...
  public ConsequenceParams setAroundRadius(Object aroundRadius) {
    return (ConsequenceParams) super.setAroundRadius(aroundRadius);
  }
  ...
  public ConsequenceParams setCursor(String cursor) {
    return (ConsequenceParams) super.setCursor(cursor);
  }
